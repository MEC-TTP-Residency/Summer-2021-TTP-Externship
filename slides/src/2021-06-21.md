...
1. For those on-site: Safety - COVID-19 precautions
...
- Room number is c09 in the AB1 Building

- IDs to log into the workstations is TTPStudent/Summer2021
...
Click on the HackerRank Assemsment invitation you got in you email.
...
- The person who's name is called says "Hi" and their class (freshman, sophomore, etc)
...
# Create a GitHub account
## Step 5: Click the 'Choose' button for your desired plan
...
We'll use today's lab as a quick demo of how to run the more common git commands
